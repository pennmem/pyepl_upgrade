# This file is generated by /opt/local/var/macports/build/_opt_local_var_macports_sources_rsync.macports.org_release_ports_python_py26-scipy/work/scipy-0.8.0/setup.py
# It contains system_info results at the time of building this package.
__all__ = ["get_info","show"]

amd_info={'libraries': ['amd'], 'library_dirs': ['/opt/local/lib']}
...
umfpack_info={'libraries': ['umfpack', 'amd'], 'library_dirs': ['/opt/local/lib']}
